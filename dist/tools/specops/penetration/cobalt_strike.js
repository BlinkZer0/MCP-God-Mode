...
export function registerCobaltStrike(server) {
    ...
    }, async ({ action, teamserver_host, teamserver_port, client_password, beacon_id, command, file_path, target_host, listener_name, listener_type, payload_type, profile_path, script_path, report_format, safe_mode, verbose }) => {
        try {
...
async function startTeamServer(host = "0.0.0.0", port = 50050, password = "password") {
    try {
        if (PLATFORM === "win32") {
...
async function connectClient(host, port, password) {
    try {
...
async function interactBeacon(beaconId) {
    try {
        return {
            success: true,
...
async function executeCommand(beaconId, command, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function uploadFile(beaconId, filePath) {
    try {
        return {
            success: true,
...
async function downloadFile(beaconId, filePath) {
    try {
        return {
            success: true,
...
async function takeScreenshot(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function startKeylogger(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function lateralMovement(beaconId, targetHost, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function establishPersistence(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function privilegeEscalation(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function credentialHarvest(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function networkReconnaissance(beaconId, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function portScan(beaconId, targetHost, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function serviceEnumeration(beaconId, targetHost, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function generatePayload(payloadType, listenerName) {
    try {
        return {
            success: true,
...
async function loadMalleableProfile(profilePath) {
    try {
        return {
            success: true,
...
async function loadAggressorScript(scriptPath) {
    try {
        return {
            success: true,
