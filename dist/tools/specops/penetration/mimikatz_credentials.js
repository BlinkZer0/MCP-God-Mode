...
export function registerMimikatzCredentials(server) {
    ...
    }, async ({ action, target_user, target_domain, target_dc, ticket_file, hash_value, output_file, custom_command, safe_mode, verbose }) => {
        try {
...
// Mimikatz Functions
async function extractCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function dumpLsass(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function extractTickets(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function goldenTicket(user, domain, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function silverTicket(user, domain, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function passTheHash(hash, user, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function passTheTicket(ticketFile, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function dcsync(user, domain, dc, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function kerberoast(user, domain, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function asreproast(user, domain, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function extractMasterkeys(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function dpapiDecrypt(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function vaultCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function wdigestCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function sspCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function tspkgCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function livesspCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function kerberosCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function msvCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function wcmdCredentials(safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function customCommand(command, safeMode) {
    if (safeMode) {
        return {
            success: true,
