import { z } from "zod";
export function registerSocialNetworkRipper(server) {
        ...
        try {
            ...
            return {
                content: [{
                        ...
                        text: JSON.stringify({
                            success: false,
                            message: `Failed to extract social network data for ${target}: ${error instanceof Error ? error.message : 'Unknown error'}`,
