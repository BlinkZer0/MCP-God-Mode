...
export function registerRfSenseGuardrails(server) {
    ...
    }, async ({ action, operation, parameters, consent, module, platform, config, user = "anonymous", sessionId }) => {
        try {
            switch (action) {
...
async function checkPlatformAction(module, platform) {
...
export { checkPlatformCompatibility, detectPlatform };
