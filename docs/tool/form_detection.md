# 🔧 Form Detection Tool - MCP God Mode

## Overview
The **Form Detection Tool** (`mcp_mcp-god-mode_form_detection`) is a comprehensive utility that provides cross-platform functionality across Windows, Linux, macOS, Android, and iOS platforms.

## Functionality
- **Core Operations**: Primary functionality for form detection
...
### Tool Identifier
- **MCP Tool Name**: `mcp_mcp-god-mode_form_detection`
...
### Basic Usage
```typescript
const result = await form_detection();
