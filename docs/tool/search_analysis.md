# 🔧 Search Analysis Tool - MCP God Mode

## Overview
The **Search Analysis Tool** (`mcp_mcp-god-mode_search_analysis`) is a comprehensive utility that provides cross-platform functionality across Windows, Linux, macOS, Android, and iOS platforms.

## Functionality
- **Core Operations**: Primary functionality for search analysis
...
### Tool Identifier
- **MCP Tool Name**: `mcp_mcp-god-mode_search_analysis`
...
### Basic Usage
```typescript
const result = await search_analysis();
