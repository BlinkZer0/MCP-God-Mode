# 🔧 Cron Job Manager Tool - MCP God Mode

## Overview
The **Cron Job Manager Tool** (`mcp_mcp-god-mode_cron_job_manager`) is a comprehensive utility that provides cross-platform functionality across Windows, Linux, macOS, Android, and iOS platforms.

## Functionality
- **Core Operations**: Primary functionality for cron job manager
...
### Tool Identifier
- **MCP Tool Name**: `mcp_mcp-god-mode_cron_job_manager`
...
### Basic Usage
```typescript
const result = await cron_job_manager();
