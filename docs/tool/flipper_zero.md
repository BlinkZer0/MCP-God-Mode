...
- `MCPGM_FLIPPER_ALLOW_TX` - Allow transmission operations (default: true)
...
- Transmission operations (IR, Sub-GHz, BadUSB) are enabled by default but can be disabled with `MCPGM_FLIPPER_ALLOW_TX=false`
