// Auto-generated JS runtime for immediate use; TS source lives beside this file.
const fs = require("fs");
...
function buildHeaderBlock(theme, toolName) {
...
function upsertReadme(toolDir, headerBlock, toolName) {
