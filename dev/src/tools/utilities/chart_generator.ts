...
export function registerChartGenerator(server: McpServer) {
...
function generatePieChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
...
function generateBarChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
...
function generateLineChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
  const maxValue = Math.max(...data.map(d => d.value));
...
function generateAreaChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
  const maxValue = Math.max(...data.map(d => d.value));
  const minValue = Math.min(...data.map(d => d.value));
  const valueRange = maxValue - minValue;
...
function generateScatterChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
  const maxValue = Math.max(...data.map(d => d.value));
  const minValue = Math.min(...data.map(d => d.value));
  const valueRange = maxValue - minValue;
...
function generateHistogramChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
...
function generateRadarChart(data: Array<{label: string; value: number}>, width: number, height: number, colors: string[], animated: boolean): string {
  const centerX = width / 2;
  const centerY = height / 2;
...
// Legend generation
function generateLegend(data: Array<{label: string; value: number}>, colors: string[], x: number, y: number, theme: string): string {
  return `
