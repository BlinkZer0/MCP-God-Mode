...
export interface PsychologicalMarker {
  name: string;
  keywords: string[];
  weight: number;
  category: string;
...
export const DSM_V_CRITERIA: DiagnosticCriteria[] = [
  {
    code: "296.20",
...
export const ICD_10_CRITERIA: DiagnosticCriteria[] = [
  {
    code: "F32.9",
    name: "Major depressive disorder, single episode, unspecified",
...
export const PSYCHOLOGICAL_MARKERS: PsychologicalMarker[] = [
  {
    name: "depressed_mood",
