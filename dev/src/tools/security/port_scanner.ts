...
async function scanWindows(target: string, ports: number[], scanType: string, timeout: number, serviceDetection: boolean, bannerGrabbing: boolean): Promise<any[]> {
  const results: any[] = [];
...
async function scanUnix(target: string, ports: number[], scanType: string, timeout: number, serviceDetection: boolean, bannerGrabbing: boolean): Promise<any[]> {
  const results: any[] = [];
...
async function scanNodeJS(target: string, ports: number[], scanType: string, timeout: number, serviceDetection: boolean, bannerGrabbing: boolean): Promise<any[]> {
  const results: any[] = [];
...
async function grabBanner(target: string, port: number, timeout: number): Promise<string> {
  const net = await import('net');
