 ...
 */
export async function scanBluetoothDevices(sessionId: string, duration: number = 10) {
 ...
 */
export async function pairBluetoothDevice(sessionId: string, address: string) {
  const session = getSession(sessionId);
