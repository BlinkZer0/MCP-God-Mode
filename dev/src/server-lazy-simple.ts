...
async function discoverTools(toolsDir: string = "dev/src/tools"): Promise<any[]> {
...
async function scanDirectory(dirPath: string, discovered: any[]): Promise<void> {
  try {
...
async function analyzeToolFile(filePath: string): Promise<any | null> {
  try {
