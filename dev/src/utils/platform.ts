...
function getMobileRootPaths(): string[] {
  if (IS_ANDROID) {
    return [
...
export function getPlatformCommand(operation: keyof typeof COMMAND_MAPPINGS.android): string {
  if (IS_ANDROID) {
...
export function getMobilePermissions(): string[] {
  if (IS_ANDROID) {
    return [
...
export function isMobileFeatureAvailable(feature: string): boolean {
...
export function getFileOperationCommand(operation: string, source: string, destination?: string): string {
  if (IS_MOBILE) {
...
function getMobileFileOperationCommand(operation: string, source: string, destination?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "copy":
...
function getWindowsFileOperationCommand(operation: string, source: string, destination?: string): string {
  switch (operation) {
    case "copy":
...
function getUnixFileOperationCommand(operation: string, source: string, destination?: string): string {
  switch (operation) {
    case "copy":
      return `cp "${source}" "${destination}"`;
    case "move":
...
export function getMobileProcessCommand(operation: string, filter?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "list":
...
export function getMobileServiceCommand(operation: string, service?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "list":
...
export function getMobileNetworkCommand(operation: string, networkInterface?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "interfaces":
        return "ip addr show";
...
export function getMobileStorageCommand(operation: string, path?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "usage":
...
export function getMobileUserCommand(operation: string, user?: string): string {
  if (IS_ANDROID) {
    switch (operation) {
      case "list":
