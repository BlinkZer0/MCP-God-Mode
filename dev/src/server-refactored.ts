...
import { 
  executeCrimeReporterCommand, 
  processNaturalLanguageCommand, 
  getCrimeReporterToolInfo,
  testCrimeReporterConfiguration 
} from "./tools/crime_reporter/tool.js";

// Import zero-day exploiter tool
import {
  executeZeroDayExploiterCommand,
  processNaturalLanguageCommand as processZeroDayNLCommand,
  getZeroDayExploiterToolInfo,
  testZeroDayExploiterConfiguration
} from "./tools/zero_day_exploiter/tool.js";
