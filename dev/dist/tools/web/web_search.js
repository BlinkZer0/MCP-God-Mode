...
async function performWebSearch(url, config, maxResults, includeSnippets, includeMetadata, timeout, headless) {
...
async function analyzeSearchResults(results, analysisType, includeVisualization) {
    const analysis = {
