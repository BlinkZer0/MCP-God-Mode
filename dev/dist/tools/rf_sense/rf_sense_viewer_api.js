 ...
 */
export function storePointCloudData(sessionId, points, metadata = {}) {
    const session = {
        id: sessionId,
        timestamp: new Date().toISOString(),
        points,
 ...
 */
export function getLatestPointCloudData() {
    if (lastSessionId) {
 ...
 */
function generatePLY(points, metadata) {
 ...
 */
export function openPointCloudViewer(port = 3000) {
