...
class TruffleHogNLProcessor {
    ...
    parseNaturalLanguage(query, context) {
    ...
    calculateConfidence(query, scanType, target) {
        let confidence = 0.5;
...
export function registerTruffleHogNL(server) {
