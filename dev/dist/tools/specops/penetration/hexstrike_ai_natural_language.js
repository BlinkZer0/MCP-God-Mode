import { z } from "zod";
export function registerHexStrikeAINaturalLanguage(server) {
...
function parseHexStrikeCommand(command) {
...
function getSuggestedTools(action) {
    const toolMappings = {
...
function calculateConfidence(command, action) {
    const commandLower = command.toLowerCase();
