...
export function registerNmapScanner(server) {
    ...
    }, async ({ action, target, ports, scan_type, timing, scripts, output_format, output_file, platform, architecture, natural_language_command, safe_mode, verbose }) => {
        try {
...
// Nmap Functions
async function hostDiscovery(target, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function portScan(target, ports, scanType, timing, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function serviceScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function osDetection(target, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function vulnerabilityScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function stealthScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function udpScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function sctpScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function ipProtocolScan(target, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function idleScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function fragmentScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function xmasScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function nullScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function finScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function ackScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function windowScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function maimonScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function customScan(target, ports, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function scriptScan(target, ports, scripts, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
async function timingScan(target, ports, timing, safeMode) {
    if (safeMode) {
        return {
            success: true,
...
function parseNmapOutput(output, scanType) {
...
function isNmapAvailable(platform) {
    switch (platform) {
