...
export function registerAudioEditing(server) {
    server.registerTool("audio_editing", {
        ...
        try {
            ...
            const { action, input_file, output_file, format, start_time, end_time, duration, sample_rate, bit_depth, channels, quality, effects, compression_level, audio_codec, bitrate, fade_duration, speed_factor, pitch_shift, noise_reduction_level, input_files, output_directory, device_name, recording_format, enable_monitoring, normalize_audio, preserve_metadata, create_backup } = params;
...
async function handleAudioRecording(params, startTime) {
...
async function simulateAudioProcessing(action, params) {
