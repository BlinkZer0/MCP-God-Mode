...
server.registerTool("system_restore", {
    ...
    inputSchema: {
        ...
        platform: zod_1.z.enum(["auto", "windows", "linux", "macos", "android", "ios"]).default("auto").describe("Target platform for the operation. 'auto' detects current platform automatically, or specify specific platform for cross-platform operations."),
        description: zod_1.z.string().optional().describe("Description for the restore point or backup. Useful for identifying the purpose of the backup (e.g., 'Before software update', 'System optimization', 'Pre-installation state')."),
