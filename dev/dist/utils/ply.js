 ...
 */
export function pointsToAsciiPLY(points, options = {}) {
 ...
 */
export function pointsToBinaryPLY(points, options = {}) {
    const { includeColors = false, includeIntensity = false, metadata = {} } = options;
...
property uchar blue`;
    ...
    normalizedPoints.forEach(point => {
        ...
        if (includeIntensity) {
            view.setFloat32(offset, point.intensity || 1.0, true);
            offset += 4;
        }
    });
 ...
 */
export function pointsToJSON(points, options = {}) {
 ...
 */
export async function savePointCloud(points, filePath, options = {}) {
 ...
 */
export function mapIntensityToColor(points, colorMap = 'viridis') {
...
function getColorFromMap(t, map) {
